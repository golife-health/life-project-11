...
const coreConceptsData = [
  {
    id: "epigenetic-clock",
    title: "Decoding Biological Time with the Epigenetic Clock",
  ...
  {
    id: "semantic-network",
    title: "Building the Neural Map of Life Extension",
  ...
  {
    id: "fhe-privacy",
    title: "Your Data, Fully Yours: Secure Storage with Homomorphic Encryption",
...
const CoreConceptsCarousel = () => {
  return (
    <section 
      id="core-concepts" 
      className="py-24 bg-gradient-to-b from-black to-[#080810] relative"
      aria-label="Core Concepts Carousel"
    >
      <div className="absolute inset-0">
        <div className="bg-blue-400/5 absolute inset-0 z-0"></div>
      </div>
              ...
              <CarouselItem key={item.id} className="md:basis-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center p-4">
                  ...
                  <div className="order-first md:order-last">
                    <div className="rounded-2xl overflow-hidden aspect-[4/3] bg-black/30 backdrop-blur-sm border border-white/10">
                      <img 
                        src={item.image} 
                        alt={item.alt}
